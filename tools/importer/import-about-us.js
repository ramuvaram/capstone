...
const PAGE_TEMPLATE = {
  ...
  sections: [
    {
      id: 's1', name: 'About / Contributors', selector: ['main.container.responsivegrid.cmp-layout-container--fixed'], style: null, blocks: ['cards-contributor'], defaultContent: ['.title.cmp-title--underline'],
    },
  ],
};
