 ...
 * after each styled section (e.g. the "grey" Featured article section).
 *
 * Breaks are inserted in beforeTransform (while every section element still
 * exists, before block parsers replace them), using a temporary marker attr as
 * a stable anchor for metadata inserted in afterTransform.
 *
 * section.selector values come directly from tools/importer/page-templates.json
