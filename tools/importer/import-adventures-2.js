...
const PAGE_TEMPLATE = {
  ...
  sections: [
    {
      id: 's1', name: 'Hero', selector: ['.teaser.cmp-teaser--hero'], style: null, blocks: ['hero-banner'], defaultContent: [],
    },
    {
      id: 's2', name: 'Current Adventures', selector: ['main.container.responsivegrid.cmp-layout-container--fixed'], style: null, blocks: ['tabs-detail'], defaultContent: ['.title.cmp-title--underline'],
    },
  ],
};
